...
import { createStudentProfile, deleteDoubt, editAnswer, editDoubt, getComplaints, getDoubtById, getDoubts, getMyAnswerForDoubt, getMyAnswers, getMyDoubts, getStudentProfile, markAnswerAsAccepted, postAnswer, postDoubt, raiseComplaint, updateStudentProfile, upvoteAnswer, } from "../controllers/studentController.js";
...
router.post("/doubts/:doubtId/answers/:answerId/accept", authenticate, authorize(Role.STUDENT), markAnswerAsAccepted);
// 17. Upvote an answer
router.post("/answers/:answerId/upvote", authenticate, authorize(Role.STUDENT), upvoteAnswer);
// 18. Post an answer to a doubt
router.post("/doubts/:doubtId/answers", authenticate, authorize(Role.STUDENT), postAnswer);
// 19. Edit an answer
...
router.get("/doubts/:doubtId/my-answer", authenticate, authorize(Role.STUDENT), getMyAnswerForDoubt);
