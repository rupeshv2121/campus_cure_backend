...
import { assignedComplaints, createFacultyProfile, updateFacultyProfile, editAnswer, getDoubtById, getDoubts, getFacultyProfile, getMyAnswers, postAnswer, verifyAnswer, } from "../controllers/facultyController.js";
...
router.post("/doubts/:doubtId/answers", authenticate, authorize(Role.FACULTY), postAnswer);
// 14. Edit an answer
router.put("/answers/:answerId", authenticate, authorize(Role.FACULTY), editAnswer);
// 15. Verify an answer
router.post("/answers/:answerId/verify", authenticate, authorize(Role.FACULTY), verifyAnswer);
