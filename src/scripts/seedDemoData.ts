...
interface SeedComplaint {
  ...
  title: string;
  description: string;
  /** 1 Low .. 5 Critical, matching the form the student sees. */
  priority: number;
  block: string;
  room: string;
  /**
...
const COMPLAINTS: SeedComplaint[] = [
  { category: "SMART_BOARD", title: "Projector not switching on", altTitle: "Projector has no power", altDescription: "The projector unit shows no power light at all, nothing happens when we press the button.", description: "The projector in this classroom does not turn on at all. The power light stays off even after checking the socket.", priority: 5, block: "ML", room: "ML03" },
  { category: "SMART_BOARD", title: "Classroom projector is dead", altTitle: "Cannot start the projector", altDescription: "Been trying to get the projector running for ten minutes with no result.", description: "Tried switching the projector on several times before the lecture, no display comes up at all.", priority: 5, block: "ML", room: "ML03", duplicateOf: 0 },
  { category: "SMART_BOARD", title: "Projector will not display anything", altTitle: "Projector shows a blank screen", altDescription: "The projector seems on but the screen stays completely blank.", description: "No image from the projector in this room, we had to cancel the presentation.", priority: 4, block: "ML", room: "ML03", duplicateOf: 0 },

  { category: "FAN", title: "Ceiling fan not working", altTitle: "Fan is completely still", altDescription: "The ceiling fan does not move at all, switch position makes no difference.", description: "The fan in the back half of the room does not spin even when the switch is on. Room gets very hot by noon.", priority: 4, block: "NL", room: "NL22" },
  { category: "FAN", title: "Fan has stopped rotating", altTitle: "No air from the ceiling fan", altDescription: "The fan has stopped and the room is stuffy during afternoon lectures.", description: "One of the ceiling fans stopped completely. It was making noise last week and now it does not move at all.", priority: 4, block: "NL", room: "NL22", duplicateOf: 3 },

  { category: "LIGHT", title: "Tube lights not glowing", altTitle: "Lights do not turn on", altDescription: "Pressing the light switches does nothing for most of the tubes in here.", description: "Half the tube lights in this room do not switch on. It is difficult to read from the back rows.", priority: 4, block: "NL", room: "NL25" },
  { category: "LIGHT", title: "Room lighting is out", altTitle: "Classroom is too dark to read", altDescription: "With the lights not working the back of the room is unusable.", description: "The lights on the left side of the classroom are not working at all.", priority: 4, block: "NL", room: "NL25", duplicateOf: 5 },

  { category: "NETWORK", title: "No wifi connectivity in the lab", altTitle: "Lab wifi will not connect", altDescription: "None of the systems in this lab can join the campus network.", description: "Wifi does not connect on any of the machines in this lab. We cannot access the course portal.", priority: 5, block: "ML", room: "ML07" },
  { category: "NETWORK", title: "Internet is down in this room", altTitle: "Cannot access the network here", altDescription: "No internet access at all in this room since morning.", description: "Cannot get any internet connection here since this morning. Practical work is blocked.", priority: 5, block: "ML", room: "ML07", duplicateOf: 7 },

  { category: "SEATING", title: "Broken chair in the classroom", altTitle: "Damaged seating in this room", altDescription: "A chair back has come away from the frame and is not safe.", description: "One chair has a cracked backrest and is unsafe to sit on. Someone could get hurt.", priority: 2, block: "NL", room: "NL21" },
  { category: "FURNITURE", title: "Desk drawer is jammed", altTitle: "Drawer will not open", altDescription: "The teaching desk drawer is stuck shut with material inside.", description: "The front desk drawer cannot be opened, the teaching material is stuck inside.", priority: 2, block: "ML", room: "ML01" },
  { category: "FAN", title: "Fan making loud rattling noise", altTitle: "Fan is very noisy", altDescription: "The fan runs but the rattling makes it hard to hear the lecture.", description: "The fan spins but rattles very loudly and is distracting during lectures. Different from it not working.", priority: 2, block: "ML", room: "ML05" },
  { category: "SMART_BOARD", title: "Smart board touch not responding", altTitle: "Board does not react to touch", altDescription: "Display is fine but nothing happens when the board is touched.", description: "The display works but touch input does nothing, so the board cannot be written on.", priority: 4, block: "NL", room: "NL24" },
  { category: "LIGHT", title: "Flickering tube light", altTitle: "Light keeps blinking", altDescription: "One tube keeps flickering on and off throughout the class.", description: "One tube light flickers constantly through the lecture and is giving people headaches.", priority: 2, block: "ML", room: "ML06" },
  { category: "SEATING", title: "Not enough benches", altTitle: "Shortage of seating", altDescription: "There are fewer seats than students so some have to stand.", description: "This room has fewer benches than students in the batch, several have to stand.", priority: 4, block: "NL", room: "NL23" },
  { category: "NETWORK", title: "Lab machines cannot reach the server", altTitle: "Systems cannot connect to department server", altDescription: "The lab computers have network but the department server is unreachable.", description: "The lab PCs are on the network but cannot reach the department server.", priority: 4, block: "ML", room: "ML08" },
  { category: "FURNITURE", title: "Whiteboard surface damaged", altTitle: "Whiteboard cannot be cleaned", altDescription: "Marker ink will not wipe off the damaged board surface.", description: "The whiteboard is scratched badly and marker writing cannot be wiped off.", priority: 2, block: "NL", room: "NL26" },
  { category: "FAN", title: "Fan regulator broken", altTitle: "Cannot control fan speed", altDescription: "The regulator has no effect, the fan stays at maximum speed.", description: "The speed regulator does not work, the fan only runs at full speed.", priority: 2, block: "NL", room: "NL27" },
];
